"""
Парсинг XML-базы данных FEText: извлечение полей физических эффектов
(название, описание, вход, объект, выход), очистка текста и сохранение
структурированных данных в форматах CSV и JSON для дальнейшей обработки.
